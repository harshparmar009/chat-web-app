...
const ProfilePage = () => {
    ...
    const {isUpdating, isUpdated, user, error } = useSelector((state) => state.auth)
        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-zinc-400">
              {isUpdating && isLoading ? "Uploading..." : "Click the camera icon to update your photo"}
            </p>
            <p className="text-sm text-zinc-400">
              {isUpdated && "Uploaded Successfully..."}
            </p>
          </div>
