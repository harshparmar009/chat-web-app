...
const Explore = () => {
  ...
  return (
      ...
      <div className="flex flex-1 overflow-hidden gap-4 pt-4">
          ...
          <section className="w-1/3 border-r border-gray-700 bg-gray-800 rounded-xl">
            <div className="p-3">
              <h2 className="flex justify-between text-sm mb-2">
                <span>Inbox</span>
                <span className="bg-red-500 text-white text-xs px-2 py-0.5 rounded-full">3 New</span>
              </h2>
              <div className="flex space-x-2 text-xs mb-4">
                <button className="text-blue-400">Primary</button>
                <button>Group</button>
        ...
        <button
          ...
          className={`
            ...
            ${userProfile?._id === user._id ? "bg-base-300 ring-1 ring-base-300" : ""}
            `
      }
        >
    ...
    {userProfile ? <ProfileContainer /> : <NoChatSelected />}
        </div>
